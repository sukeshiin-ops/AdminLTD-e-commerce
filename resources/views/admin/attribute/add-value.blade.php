    ...
    <div class="container-fluid mt-4">
        ...
        <div class="card shadow border-0">
            ...
            <div class="card-header d-flex justify-content-between align-items-center text-white"
                ...
                <h5 class="mb-0">
                    <i class="fa-solid fa-boxes-stacked"></i> Add Value For <span class="text-warning">{{ $attribute->first()->name }}</span>
                </h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('store-value-now',$attribute->first()->id) }}" method="POST">
                    @csrf
